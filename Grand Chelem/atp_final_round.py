...
def get_seventh_round_winner(soup):
    colonne8 = soup.find("td", "col_8")

    player = colonne8.find("div", "playerWrap")
    score = colonne8.find("div", "scores")

    return player.a.string, score.a.string
...
while l < len(tournamentList):
    ...
    for tournamentYear_url in tournamentYear_urls:
        ...
        sixth_round_winner = get_player_name_sixth_round_winner(soup)

        winner, score = get_seventh_round_winner(soup)

        # Le nombre de gagnant étant égale au nombre de match jouer, on boucle sur ce nombre qui sera le nombre de lignes produites
        while i < len(get_seventh_round_winner(soup)):
            player1 = sixth_round_winner[j] #
            player2 = sixth_round_winner[j+1]
            winner, score = get_seventh_round_winner(soup)
