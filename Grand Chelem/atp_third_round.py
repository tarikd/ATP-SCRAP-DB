...
def get_third_round_winner(soup):
    colonne4 = soup.find("td", "col_4")
    player = colonne4.findAll("div", "playerWrap")
    scores = colonne4.findAll("div", "scores")

    list_name_winner_third_round = []
    list_score_winner_third_round = []

    for name in player:
        list_name_winner_third_round.append(name.a.string)
    for score in scores:
        list_score_winner_third_round.append(score.a.string)

    return list_score_winner_third_round, list_name_winner_third_round
