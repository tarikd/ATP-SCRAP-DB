...
def get_sixth_round_winner(soup):
    colonne7 = soup.find("td", "col_7")
    player = colonne7.findAll("div", "playerWrap")
    scores = colonne7.findAll("div", "scores")

    list_name_winner_sixth_round = []
    list_score_winner_sixth_round = []

    for name in player:
        list_name_winner_sixth_round.append(name.a.string)
    for score in scores:
        list_score_winner_sixth_round.append(score.a.string)

    return list_score_winner_sixth_round, list_name_winner_sixth_round
...
while l < len(tournamentList):
    ...
    for tournamentYear_url in tournamentYear_urls:
        ...
        while i < len(get_sixth_round_winner(soup)[0]):
            player1 = fifth_round_winner[j] #
            player2 = fifth_round_winner[j+1]
            winner = get_fifth_round_winner(soup)[1][i]
            score = get_fifth_round_winner(soup)[0][i]
