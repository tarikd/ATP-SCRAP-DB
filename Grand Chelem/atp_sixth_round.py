...
def get_players_name(soup, soup3, soup4):
...
def get_player_specific_rank(soup, soup3, soup4, player):
    dico = {}
    dico.clear()
    i = 0
    rank = 1
    while i < len(get_players_name(soup, soup3, soup4)):
        name = get_players_name(soup, soup3, soup4)[i].replace("\xc2\xa0", " ")
...
while l < len(tournamentList):
    ...
    for tournamentYear_url in tournamentYear_urls:
        ...
        # On construit une url menant au classement atp qui coïncide le plus avec le tournoi (201 - 300)
        URL4 = "http://www.atpworldtour.com/Rankings/Singles.aspx?d=" + get_closest_tournament_date(soup) + "&r=201"
        ...
        fifth_round_winner = get_player_name_fifth_round_winner(soup)
        ...
        while i < len(get_player_name_sixth_round_winner(soup)):
            player1 = fifth_round_winner[j] #
            player2 = fifth_round_winner[j+1]
            winner = get_player_name_sixth_round_winner(soup)[0]
            score = get_player_score_sixth_round_winner(soup)[0]
            rank1 = get_player_specific_rank(soup2, soup3, soup4, player1)
            rank2 = get_player_specific_rank(soup2, soup3, soup4, player2)
